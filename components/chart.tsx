...
export default function ChartBarInteractive() {
    ...
    const total = React.useMemo(() => {
        return {
            desktop: chartData.reduce((acc, curr) => {
                return acc + curr.desktop;
            }, 0),
            mobile: chartData.reduce((acc, curr) => {
    ...
    return (
        <Card className="py-0">
            <CardHeader className="border-b flex flex-col items-stretch p-0! sm:flex-row">
                        ...
                        return (
                            <button
                                className={`
                                  ...
                                  even:border-l
                                  flex flex-1 flex-col gap-1 justify-center px-6 py-4 relative
                            ...
                            >
                                ...
                                <span className="font-bold leading-none sm:text-3xl text-lg">
